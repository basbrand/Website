      ...
      <div class="post__main isolation">
        <div class="wings">
          <nav class="trail meta leader trailer bleed">
            <ol class="list--reset list--inline">
              <li><a class="anchor--shy" href="/cases/">Bedenken</a></li>
            </ol>
          </nav>
        ...
        <footer class="well well--discover seed wings leader--hero">
          ...
          <div class="seed__footer">
            <div class="leader trailer--hero"><a class="button button--inverse anchor--shy" href="mailto:stef@brickson.nl?subject=Bedenken%20met%20Stef">Meer weten over bedenken?</a></div>
          </div>
        </footer>
      </div>
