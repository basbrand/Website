    ...
    <nav class="navbar media">
      <ol class="menu menu--hero list--reset fx bleed" id="menu">
        <li class="gutters">
          ...
          <a class="menu__item meta meta--hero anchor--reset anchor--shy is-current is-active" href="/werken-bij-brickson/#menu">Werken bij Brickson</a>
        </li>
        ...
        <li><a class="menu__item anchor--shy meta meta--tiny fx is-active" href="/werken-bij-brickson/">Werken bij Brickson</a></li>
      </ol>
    </nav>
    <article class="post">
      <header class="hero hero--navbar seed pod pod--hippo cover isolation">
        <picture>
          <img class="cover__image" src="/images/content/werken-bij-brickson.jpg">
        </picture>      <div class="hero__body seed__body backdrop">
        ...
        <div class="wings">
          <nav class="trail meta leader--tiny trailer bleed">
            <ol class="list--reset list--inline">
              <li><a class="anchor--shy" href="/cases/">Werken bij Brickson</a></li>
            </ol>
          </nav>
