<div class="tools">
  <div class="tools__header wings">
    <h2 class="gutters title title--section  leader--giant trailer--giant">Onze producten</h2>
    <em class="gutters title">Krachtige tools voor slimme stappen</em>
  </div>
  <div class="tools__body grid grid--tools wings leader--hero trailer--giant">
