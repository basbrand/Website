<div class="testimonial cover cover--neutral">
  <picture class="cover__image">
    ...
    <source
      ...
      srcset="/images/content/w1599px_h496px--evean.jpg 683w, /images/content/w1599px_h496px--evean.jpg 1366w">
    <source
  ...
  <div class="well testimonial__body">
    ...
    <div class="well__footer  leader--hero">
      <a class="button button--stretch button--inverse" href="/cases/evean/#main">Case: Evean</a>
    </div>
  </div>
</div>
