  ...
  <div class="well well--hero cover">
    <picture class="cover__image" id="main">
      ...
      <source
        ...
        srcset="/images/content/w1120px_h512px--evean.jpg 1280w, /images/content/w1120px_h512px--evean.jpg 2560w">
      <source
        media="<?php echo $gt_small_desktop; ?> and <?php echo $landscape; ?>"
        srcset="/images/content/w1280px_h492px--evean.jpg 683w, /images/content/w1280px_h492px--evean.jpg 1366w">
      <source
  ...
  <div class="well well--hero cover">
    <picture class="cover__image">
      ...
      <source
        ...
        srcset="/images/content/w560px_h512px--eigenhuis.jpg 683w, /images/content/w560px_h512px--eigenhuis.jpg 1366w">
      <source
        media="<?php echo $gt_large_handheld; ?> and <?php echo $portrait; ?>"
